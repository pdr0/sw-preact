...
let referenceIframe = document.getElementById('reference');
let sampleIframe = document.getElementById('sample');
...
function fixHeight(evt) {
	...
	let document = iframe.contentWindow.document.documentElement;
